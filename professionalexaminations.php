<?php
  $page_id  = 'professional-examinations';
  $active   = "about";
...
<main>
  ...
  <div class="container">
    <div class="row align-items-center g-4">
      <div class="col-lg-7">
        ...
        <h1 class="mb-2">SIET Professional Examinations</h1>
        <!-- <p class="lead mb-0">
  ...
  <!-- ======================
       ...
       ====================== -->
  <section class="pe-wrap py-4">
    <div class="container">

      <div class="pe-paper" role="article" aria-label="SIET Professional Examinations">
        <div class="pe-frame">

          <h1 class="pe-title">SIET Professional Examinations</h1>

          <div class="pe-body">

            <p class="pe-paragraph">
              For more than 15 years (1981 – 1998), SIET had played an important role in organizing
              ‘Preparation Courses’ for members who were also Polytechnic and ITE Engineering graduates to sit for two
              UK – Professional Examinations :
            </p>

            <ol class="pe-list">
              <li><strong>1995 - The Society of Engineers Graduateship Examinations, UK;</strong></li>
              <li><strong>1988 - Engineering Council Examinations, UK</strong></li>
            </ol>

            <p class="pe-paragraph pe-strongline">
...
<div class="pe-table-block" aria-label="Professional examinations table">
  ...
  <div class="pe-table-wrap">
    <table class="pe-table" role="table" aria-label="SIET professional examinations milestones">
      <thead>
        <tr>
      ...
      <tbody>
        <tr>
            ...
            <p class="pe-paragraph">
              With the phasing out of the UK- Engineering Council Examinations in 2011, SIET Council decided officially
            ...
            <div class="pe-indent">
              <p class="pe-paragraph mb-2">
                (1) IEM/BEM Part 1 (8 subjects) as satisfying its academic requirement for the grade of Member (MSIET); and
              </p>
              <p class="pe-paragraph mb-2">
                (2) IEM/BEM Part 2 (6 compulsory subjects) as satisfying its academic requirement for the grade of Fellow (FSIET).
              </p>
              <p class="pe-paragraph mb-0">
...
<div>
  ...
  <style>
    ...
    /* Back button styles (same reusable style) */
    .page-back-section{
      padding: 12px 0 0;
      margin-bottom: 12px;
    }
    ...
    @media (max-width: 992px){
      .pe-title{ font-size: 2rem; }
      .pe-table-grid{ grid-template-columns: 1fr; }
      .pe-figure--full{ grid-column: auto; }
    }
    @media (max-width: 576px){
      .pe-frame{ padding: 16px; }
      .pe-title{ font-size: 1.7rem; }
      .pe-body{ font-size: 1rem; }
    }
    /* =========================================================
   REAL TABLE STYLES (Professional Examinations)
   ========================================================= */
.pe-table-title{
  margin: 0 0 10px 0;
  font-weight: 900;
...
.pe-pathway-figure{
  margin: 0;
  border: 2px solid rgba(17,24,39,.85); /* bold frame like slide */
  border-radius: 10px;
  overflow: hidden;
  background: #fff;
  box-shadow: 0 14px 26px rgba(0,0,0,.10);
